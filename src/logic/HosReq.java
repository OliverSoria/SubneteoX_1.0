...
public class HosReq extends Prefix {
	public long dir;
	public String n;
	int hostReq;
	
	public HosReq (String aS, String bS, String cS, String dS) {
	...
	public int m(int host){
        int n = 1;
                
        for(int i = 2; i < host; i *= 2)
            n++;
               
        return n;
    }
	
	public String n(long direc, int pre) {
    	int n1 = 0;
